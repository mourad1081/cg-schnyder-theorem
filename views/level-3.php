...
<main id="level-3" class="container">
    ...
    <div class="theory animated bounceInUp container">
        ...
        <div id="actions-level-3">
            <button id="btn-start-quizz-level-3" class="btn big-button">Play quizz</button>
        </div>
    </div>

    <div id="container-questions-level-3" class="row">
    ...
    <div id="congratulations-level-3" class="container d-none">
        ...
        <button id="btn-next-level-3" class="btn big-button">Next level</button>
    </div>
</main>
